...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'dokumen_db' => [
            'driver'    => 'mysql',
            'host'      => env('DOKUMEN_DB_HOST', '127.0.0.1'),
            'port'      => env('DOKUMEN_DB_PORT', '3306'),
            'database'  => env('DOKUMEN_DB_DATABASE', 'dokumen_db'),
            'username'  => env('DOKUMEN_DB_USERNAME', 'root'),
            'password'  => env('DOKUMEN_DB_PASSWORD', ''),
            'charset'   => 'utf8mb4',
