...
<head>
    ...
    <title>{{ $folder->nama }} — Drive Sekolah</title>
    ...
    <style>
        ...
        .btn-back {
            ...
            justify-content: center; color: #374151; text-decoration: none;
                ...
                <div class="d-flex align-items-center justify-content-between mb-4 mt-1 flex-wrap gap-2 page-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0 d-none d-sm-block">{{ $folder->nama }}</p>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('dokumen.folder.store') }}" method="POST" class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4">
                    ...
                    <input type="text" name="nama" class="form-control" placeholder="Contoh: Semester 1" required autofocus>
                </div>
