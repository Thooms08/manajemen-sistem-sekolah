...
<head>
    ...
    <style>
        ...
        @media (max-width: 767px) {
            ...
            .tx-item .d-flex { flex-direction: column; align-items: flex-start !important; gap: 4px; }
            .tx-item .tx-amount { font-size: 0.85rem; }
        }
    </style>
</head>
<body>
@php
    $__canCreate = can('laporan_keuangan', 'create');
    $__canEdit   = can('laporan_keuangan', 'edit');
    $__canDelete = can('laporan_keuangan', 'delete');
@endphp
            ...
            <div class="d-flex align-items-center mb-4 mt-2 flex-wrap gap-2 page-header">
                ...
                <div class="ms-auto">
                    <a href="{{ route('keuangan.laporan.export-excel', array_filter(['periode' => $periode, 'date_from' => $dateFrom, 'date_to' => $dateTo])) }}"
                       class="btn btn-success btn-sm px-4 fw-semibold shadow-sm w-100 w-sm-auto">
