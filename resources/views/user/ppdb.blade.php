...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Payment cards */
            .payment-card .d-flex { flex-direction: column; gap: 10px; }
            .payment-card .text-end { text-align: start !important; }
            .qris-image { max-width: 160px; }

            /* Step header */
            .step-header { font-size: 1rem; margin-bottom: 18px; }
        ...
        @media (max-width: 576px) {
            ...
            .step-indicator .step { width: 30px; height: 30px; margin: 0 3px; font-size: 0.8rem; }
            .card { padding: 14px !important; border-radius: 10px !important; }
            h4.fw-bold { font-size: 1.1rem; }
            .step-header { font-size: 0.95rem; padding-bottom: 8px; }
        }
    </style>
</head>
<body>
