                ...
                <div class="col-lg-6">
                    ...
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            @if($__canCreate)<button class="btn btn-success btn-sm px-3" data-bs-toggle="modal" data-bs-target="#modalTambahPembina">
                    ...
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            @if($__canCreate)<button class="btn btn-success btn-sm px-3" data-bs-toggle="modal" data-bs-target="#modalTambahBagan">
                                <i class="bi bi-plus-lg me-1"></i>Tambah
                            </button>@endif
                        </div>
                        <div class="section-body">
                            @forelse($program->bagans as $bg)
                                <div class="bagan-card">
                                    ...
                                    <div class="d-flex gap-1">
                                        @if($__canEdit)<button class="btn btn-sm btn-outline-success border-0" title="Edit" onclick="openEditBagan({{ $bg->id }})">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            @if($__canCreate)<button class="btn btn-success btn-sm px-3" data-bs-toggle="modal" data-bs-target="#modalTambahAnggota">
