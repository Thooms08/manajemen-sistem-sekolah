...
<head>
    ...
    <style>
        ...
        .staff-card-item .sc-actions { display: flex; gap: 6px; margin-top: 10px; flex-wrap: wrap; }
        .staff-card-item .sc-actions .btn { flex: 1 1 calc(50% - 6px); font-size: 0.8rem; }
        ...
        @media (max-width: 575px) {
            ...
            .staff-card-item { padding: 12px 13px; }
            .staff-card-item .sc-actions .btn { flex: 1 1 100%; }
...
<body>
@php
    $__canCreate = can('data_staff', 'create');
    $__canEdit   = can('data_staff', 'edit');
    $__canDelete = can('data_staff', 'delete');
@endphp
    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4 mt-2 flex-wrap gap-2 page-header">
                ...
                @if($__canCreate)<button class="btn btn-success px-4 shadow-sm fw-bold btn-tambah" data-bs-toggle="modal" data-bs-target="#modalTambahStaff">
...
<div class="modal fade" id="modalNonaktifStaff" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            @if($__canDelete)<form id="formNonaktifStaff" method="POST" enctype="multipart/form-data">
                @csrf @method('DELETE')
