...
<head>
    ...
    <style>
        ...
        .search-box-wrapper { min-width: 220px; flex: 1 1 260px; max-width: 420px; }
        ...
        .guru-card-item.guru-card-nonaktif { border-left-color: #dc3545; }
        ...
        .guru-card-item .card-actions { display: flex; gap: 6px; margin-top: 10px; flex-wrap: wrap; }
        .guru-card-item .card-actions .btn { flex: 1 1 calc(50% - 6px); font-size: 0.8rem; }
        ...
        @media (max-width: 575px) {
            ...
            .guru-card-item { padding: 12px 13px; }
            .guru-card-item .card-actions .btn { flex: 1 1 100%; }
...
<body>
@php
    $__canCreate = can('data_guru', 'create');
    $__canEdit   = can('data_guru', 'edit');
    $__canDelete = can('data_guru', 'delete');
@endphp
    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4 mt-2 flex-wrap gap-2 page-header">
                ...
                @if($__canCreate)<button class="btn btn-success px-4 shadow-sm fw-bold btn-tambah" data-bs-toggle="modal" data-bs-target="#modalTambahGuru">
            ...
            <form action="{{ route('guru.store') }}" method="POST">
                ...
                <div class="modal-body p-4 row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" name="no_whatsapp" class="form-control" required placeholder="contoh: 08123456789">
                    </div>
                    <div class="col-12">
...
<div class="modal fade" id="modalNonaktifGuru" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            @if($__canDelete)<form id="formNonaktifGuru" method="POST" enctype="multipart/form-data">
                @csrf @method('DELETE')
