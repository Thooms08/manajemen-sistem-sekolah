...
class PpdbFormSettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $muridFields = [
            ...
            ['field_name' => 'nis_lama', 'field_label' => 'NIS Lama', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 4],
            ['field_name' => 'nis_baru', 'field_label' => 'NIS Baru', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 5],
            ['field_name' => 'nik', 'field_label' => 'NIK', 'field_category' => 'murid', 'is_active' => true, 'is_required' => true, 'sort_order' => 6],
            ['field_name' => 'tempat_lahir', 'field_label' => 'Tempat Lahir', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 8],
            ['field_name' => 'tgl_lahir', 'field_label' => 'Tanggal Lahir', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 9],
            ['field_name' => 'rt_rw', 'field_label' => 'RT/RW', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 10],
            ['field_name' => 'desa_kelurahan', 'field_label' => 'Desa/Kelurahan', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 11],
            ['field_name' => 'kota_kabupaten', 'field_label' => 'Kota/Kabupaten', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 12],
            ['field_name' => 'provinsi', 'field_label' => 'Provinsi', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 13],
            ['field_name' => 'alamat_detail', 'field_label' => 'Alamat Detail', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 14],
            ['field_name' => 'transportasi', 'field_label' => 'Transportasi', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 15],
            ['field_name' => 'no_hp', 'field_label' => 'No. HP', 'field_category' => 'murid', 'is_active' => true, 'is_required' => true, 'sort_order' => 16],
            ['field_name' => 'alamat_email', 'field_label' => 'Email', 'field_category' => 'murid', 'is_active' => true, 'is_required' => true, 'sort_order' => 17],
            ['field_name' => 'sekolah_asal', 'field_label' => 'Sekolah Asal', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 18],
            ['field_name' => 'tinggi_badan', 'field_label' => 'Tinggi Badan', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 19],
            ['field_name' => 'berat_badan', 'field_label' => 'Berat Badan', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 20],
            ['field_name' => 'anak_ke', 'field_label' => 'Anak Ke', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 21],
            ['field_name' => 'jlm_saudara', 'field_label' => 'Jumlah Saudara', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 22],
            ['field_name' => 'jumlah_kakak', 'field_label' => 'Jumlah Kakak', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 23],
            ['field_name' => 'jumlah_adik', 'field_label' => 'Jumlah Adik', 'field_category' => 'murid', 'is_active' => true, 'is_required' => false, 'sort_order' => 24],
        ];
